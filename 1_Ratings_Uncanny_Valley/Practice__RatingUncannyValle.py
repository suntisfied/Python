...
ntRA=2; ntRD=2; ntRR=2; ntHA=2; ntHD=2; ntHR=2;
#ntRA=114; ntRD=86; ntRR=70; ntHA=96; ntHD=106; ntHR=84;
...
win = visual.Window(allowGUI=False, size=[1600,900], colorSpace= "rgb255", color = 130, fullscr = True, screen = screenNum, monitor='testMonitor', units='pix')
...
RApath = os.getcwd() + '/pracImages/Robot-like/Animation/'
RDpath = os.getcwd() + '/pracImages/Robot-like/Doll/'
RRpath = os.getcwd() + '/pracImages/Robot-like/Robot/'
HApath = os.getcwd() + '/pracImages/Human-like/Animation/'
HDpath = os.getcwd() + '/pracImages/Human-like/Doll/'
HRpath = os.getcwd() + '/pracImages/Human-like/Robot/'
...
#    print 'nImgs=',nImgs, nImgA[this][thisBlock+1],nImgA[this][thisBlock]
    ...
    for thisRange in range(len(nImgA)):
        imageNum=nImgA[thisRange][thisBlock];#numbering of image
        imageType=imageRangeName[thisRange]
        for thisImg in range(int(nImgA[thisRange][thisBlock]),int(nImgA[thisRange][thisBlock+1])):
            trialNum=trialNum+1
            imageNum=imageNum+1
            
#            print int(nImgA[thisRange][thisBlock]),int(nImgA[thisRange][thisBlock+1])
...
#            print 'strImg=',nImgA[thisRange][thisBlock]
